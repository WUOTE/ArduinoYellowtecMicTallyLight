...
void setLightMode() {
  ...
  if (currentMode == "idle") {
    ...
    for (i = 0; i < sizeOftallyTable; i++) {
      ...
      // Bumping minimal intensity to further decrease flickering at lower levels
      int intensityMapped = map(lightIntensity, 0, 255, 20, 255);
      motor.setSpeed(intensityMapped);
      delay(5);
    }
  }
